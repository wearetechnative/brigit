...
- MUST generate `brigit-repos-{timestamp}.txt` if issues found
...
Issue file: brigit-repos-{YYYYMMDD_HHMMSS}.txt
...
- **Enforcement**: Uses scan output (`brigit-repos-*.txt`) as input
