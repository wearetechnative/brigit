...
2. Review `brigit-repos-{timestamp}.txt` output
3. Edit file to remove any repos that shouldn't be modified
4. Run `brigit enforce -f brigit-repos-{timestamp}.txt`
...
# Output: brigit-repos-20260226_184729.txt

# Review and edit the file if needed
# Then enforce
brigit enforce -f brigit-repos-20260226_184729.txt
```
